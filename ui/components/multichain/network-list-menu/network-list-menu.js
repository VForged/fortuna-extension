...
export const NetworkListMenu = ({ onClose }) => {
  ...
  const networksList = newOrderNetworks().filter((network, index) => {
    return (
      network.nickname == 'Elysium Mainnet' ||
      network.nickname == 'Polygon Mainnet' ||
      network.nickname == 'Ethereum Mainnet' ||
      network.nickname == 'Atlantis Testnet'
